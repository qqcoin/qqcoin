...
After completing windows setup then run windows command line (cmd)
  cd daemon
  QQcoind
You would need to create a configuration file QQcoin.conf in the default
wallet directory. Grant access to QQcoind.exe in anti-virus and firewall
...
QQcoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
QQcoind stop
Start up the new QQcoind (0.3.0).
